...
function move() {
    ...
    if (!isSnakeUnit(new_unit) && new_unit !== undefined && isNotBlockUnit(new_unit)) {
...
function createBlock() {
  ...
  var block_cell = document.getElementsByClassName('cell-' + pos.y + '-' + pos.x)[0];
